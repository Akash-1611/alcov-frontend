          ...
          >
            ...
            >
              ...
              <div className="relative w-48 h-32 overflow-hidden rounded-2xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-alcovia-orange/30 via-alcovia-red/20 to-alcovia-orange/10" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <BookOpen size={40} className="text-alcovia-orange/60" />
                </div>
            ...
            >
              {/* Background with image */}
              <div className="relative w-48 h-32 overflow-hidden rounded-2xl">
                {/* Outside Image Placeholder */}
                <div className="absolute inset-0 bg-gradient-to-br from-alcovia-red/30 via-alcovia-pink/20 to-alcovia-red/10" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <Briefcase size={40} className="text-alcovia-red/60" />
                </div>
